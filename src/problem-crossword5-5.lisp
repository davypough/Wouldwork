;;;; Filename: problem-crossword5-5.lisp
              ...
              do (text $cross-field $new-cross-str)
                 (if (full-word $new-cross-str)
                   (do (setf $new-cross-word (intern $new-cross-str))
                       (if (gethash $new-cross-word *words-ht*)  ;(member $new-cross-word *sorted-words*)  ;otherwise leave dictionary filling
